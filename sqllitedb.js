         ...
         createdOn text 
            ...
            (err) => {
               if (err) {
                  ...
                  var insert = 'INSERT INTO buku (judul, penulis, tahun_terbit, asal, createdOn) VALUES (?,?,?,?,?)'

                  db.run(insert, ['Buku A', 'Penulis A', '2020', 'Asal A', '2020-05-26 10:10'])
                  db.run(insert, ['Buku B', 'Penulis B', '2021', 'Asal B', '2020-05-28 11:10'])
                  db.run(insert, ['Buku C', 'Penulis C', '2022', 'Asal C', '2020-05-29 09:22'])
                  db.run(insert, ['Buku D', 'Penulis D', '2023', 'Asal D', '2020-06-06 16:18'])
               }
            }
      );   
   }
